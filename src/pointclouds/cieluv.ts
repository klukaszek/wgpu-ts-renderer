...
export class CIELUVPointCloud extends PointCloud {
    ...
    private xyzBuffer: GPUBuffer | undefined;

    private ppmBGL = WGPU_RENDERER.device.createBindGroupLayout({
        entries: [
            {
                binding: 0,
    ...
    private luvBuffer: GPUBuffer | undefined;

    private rgbToXYZKernel = `
    ...
    constructor(gridSize: number, ppmTexture?: PPMTexture) {
